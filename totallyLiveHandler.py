...
class TrendsHandler(webapp.RequestHandler):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), 'totallyLiveTemplates/trends.html')
    self.response.out.write(template.render(path, template_values))
...
class JustPicsHandler(webapp.RequestHandler):
  ...
  def get(self):
    ...
    path = os.path.join(os.path.dirname(__file__), 'totallyLiveTemplates/pictweets.html')
    self.response.out.write(template.render(path, template_values))
